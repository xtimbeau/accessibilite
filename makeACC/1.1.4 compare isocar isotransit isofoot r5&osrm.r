...
ggplot(data, aes(x=iso10m.osrm, y=iso12m.r5))+geom_point(alpha=0.1)+geom_smooth(method="lm")
...
## walk ---------
# r5
dir.create("{localdata}/ttemp4" %>% glue, recursive=TRUE)
