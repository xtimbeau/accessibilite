...
car_r5_Toulouse <- routing_setup_r5(path="{DVFdata}/r5r_data/Toulouse/r5" %>% glue, mode="CAR")
...
iso_transit_50_r5_Toulouse <- iso_accessibilite2(quoi=iris15_lgdrous, # les variables d'opportunité
                                       ...
                                       routing=tr_r5_Toulouse) # moteur de routing

save_DVF(iso_transit_50_r5_Toulouse)

tm_shape(iso_transit_50_r5_Toulouse$EMP09)+tm_raster(style="cont", palette=heatrg)
...
iso_car_50_osrm_Toulouse <- iso_accessibilite2(quoi=iris15_lgdrous, # les variables d'opportunité
                                       ...
                                       pdt=5, # le pas de temps pour retourner le résultat en minute
                                       routing=car_osrm_Toulouse) # moteur de routing

save_DVF(iso_car_50_osrm_Toulouse)
...
save_DVF(iso_foot_50_osrm_Toulouse)

tm_shape(iso_foot_50_osrm_Toulouse$EMP09)+tm_raster(style="cont", palette=heatrg)
