...
ttrr5_emp09_lyon <- aggregate(ttrr5_emp09_lyon, 4) #agrège à la résolution 200=4*50
lyon_dt <- r2dt(ttrr5_emp09_lyon)
lyon_dt <- merge(lyon_dt, c200[, c("idINS200", "Ind")], by.x="idINS", by.y="idINS200")  # ajoute la colonne Ind aux données
