...
ttr_emp09_25_Lyon <- calc(norm_tr, fun= function(x) fisoinv(x, isotimes=isotimes, seuil=0.25))
ttr_emp09_30_Lyon <- calc(norm_tr, fun= function(x) fisoinv(x, isotimes=isotimes, seuil=0.3))
